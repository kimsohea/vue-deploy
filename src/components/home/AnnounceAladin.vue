<template>
  <section class="site_announce">
    ...
    <figure class="deco">
      <img :src="IntroBack1" alt="사이트 소개 단락 뒷 꾸밈요소" />
      <img :src="IntroBack2" alt="사이트 소개 단락 뒷 꾸밈요소" />
    </figure>
  </section>
</template>
...
import IntroBack1 from '@/assets/img/site_intro_back_01.png'
import IntroBack2 from '@/assets/img/site_intro_back_02.png'
