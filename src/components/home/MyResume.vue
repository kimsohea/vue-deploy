    ...
    <section class="my_resume" @mousemove="handleEye">
        ...
        <div class="resume_wrap">
            <figure class="mascot" :class="eyeClass">
                ...
                <img class="open_eye" alt="고양이 동공" :src="catEye"
            ...
            <ul class="resume">
                <li>
                    <h3>교육 이수내역</h3>
                    <ul>
                        <li>UI/UX 반응형 웹디자인&웹퍼블리셔 양성과정 B 그린컴퓨터아카데미(성남) <span>2022년 08월 ~ 2023년 01월</span></li>
                        <li>다이나믹 클라이언트 스크립트 기초 <span>2022년 10월</span></li>
                        <li>(과정평가형)웹디자인 기능사 A 그린컴퓨터아카데미 신촌 <span>2022년 05월 ~ 2023년 01월</span></li>
                    </ul>
                </li>
                <li>
                    <h3>경력사항</h3>
                ...
                <li class="public_site">
                    <h3>퍼블리싱 사이트</h3>
                    <ul>
                        <li>1300k <a href="https://obozfootwear.co.kr/" target="_blank">사이트 바로가기</a></li>
                        <li>가방팝 <a href="https://obozfootwear.co.kr/" target="_blank">사이트 바로가기</a></li>
                        <li>오보즈코리아 <a href="https://obozfootwear.co.kr/" target="_blank">사이트 바로가기</a></li>
                        <li>럭스닷 <a href="https://luxxdot.com/" target="_blank">사이트 바로가기</a></li>
                        <li>coltorti boutique<a href="https://www.coltortiboutique.co.kr/" target="_blank">사이트 바로가기</a>
                        </li>
                        <li>마모트코리아 공식홈페이지 <a href="https://marmotkorea.kr/" target="_blank">사이트 바로가기</a></li>
                        <li>웨어라운지 wearLounge <a href="https://wearlounge.com/" target="_blank">사이트 바로가기</a></li>
                        <li>더블유랩 WLAB <a href="https://obozfootwear.co.kr/" target="_blank">사이트 바로가기</a></li>
                        <li>NHN WETOO 공식홈페이지 <a href="https://www.nhnwetoo.com/" target="_blank">사이트 바로가기</a></li>
                        <li>아이카사 코리아 공식홈페이지 <a href="https://aykasa-korea.co.kr/" target="_blank">사이트 바로가기</a></li>
                    </ul>
                </li>
            </ul>
        </div>
